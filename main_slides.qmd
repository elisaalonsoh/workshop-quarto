...
- 5.1. The `_quarto.yml` project file
- 5.2. Preview vs. render
...
- Quarto uses **Markdown** for text formatting, which relies on symbols to indicate formatting (e.g. for headings, **bold** or *italics*)
...
::: {.notes}
Timing: ~8 min. Show the rendered HTML report you prepared ahead of time as backup.
:::
